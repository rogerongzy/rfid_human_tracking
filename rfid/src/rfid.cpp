...
CMyApplication::setImpinjReaderConfig(void)
{
    ...
    */
    ...
    pC1G2Rf->setModeIndex(0); /* impinj read mode here !!*/
    ...
    char *                        av[])
{
    ...
    ros::NodeHandle nh;
    this->rfid_publisher = nh.advertise<rfid::rfid_msg>("/rfid_message", 15); // queue_size is initially set to 10, totally 6 antenna
}
