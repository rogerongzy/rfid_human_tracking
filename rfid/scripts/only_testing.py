...
if __name__ == "__main__":
    ...
    # params
    tag_size = 0.16
    fx, fy = 649.376, 649.376 # focal_length
    cx, cy = 648.137, 353.517 # principal_point
    ...
    try:
        while True:
            ...
            for tags in tags_list:
                if tags.tag_id == 0:
                    pose, _, _ = tag_detector.detection_pose(tags, camera_params=(fx, fy, cx, cy), tag_size=tag_size)
                    position = pose[:3, 3]
                    rotation = pose[:3, :3]
                    print(position)
                    # print(rotation)
